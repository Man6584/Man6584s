...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            --Assignment: with each level, tiles will create with more variation in its looks
            table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(math.min(10, self.level + 3)), math.random(math.min(6, self.level))))
        end
    end
    ...
    for y = 1, 8 do
        ...
        for x = 2, 8 do
            ...
            if self.tiles[y][x].color == colorToMatch then
                ...
                if matchNum >= 3 then
                    local match = {}
                    --Assignment: Make the match 'shiny' if there's a shiny tile
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                --Assignment:with each level, tiles will create with more variation in its looks
                local tile = Tile(x, y, math.random(math.min(10, self.level + 3)), math.random(math.min(6, self.level)))
                tile.y = -32
                self.tiles[y][x] = tile
...
--Assignment: New function, being used to find matches
    ...
    for x = 1, 8 do
        for y = 1, 8 do
            ...
            for y2 = y - 1, y + 1, 2 do
                ...
                --Cloning the class to get a temporary board for calculation
