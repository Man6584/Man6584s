...
--Have to make this global to make it stop on pause
...
function love.load()
    ...
    sounds = {
        ...
        --our new pause effect
        ['pause'] = love.audio.newSource('pause.wav', 'static')
        }
    --Our award table which determine our badge
    --It also receive the image file within our folder
    awards = {
