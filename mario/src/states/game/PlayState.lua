...
function PlayState:init()
    self.camX = 0
    self.camY = 0
    self.level = LevelMaker.generate(((LEVELCOUNT - 1) * 20) + 100, 10)
...
function PlayState:render()
    ...
    love.graphics.setFont(gFonts['medium'])
    love.graphics.setColor(0, 0, 0, 1)
    love.graphics.print('Level: ' .. tostring(LEVELCOUNT), VIRTUAL_WIDTH / 2 - 25, 5)
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.print('Level: ' .. tostring(LEVELCOUNT), VIRTUAL_WIDTH / 2 - 25, 4)
