...
function Player:checkLeftCollisions(dt)
    ...
    local tileBottomLeft = self.map:pointToTile(self.x + 3, self.y + self.height - 1)
...
function Player:checkRightCollisions(dt)
    ...
    local tileBottomRight = self.map:pointToTile(self.x + self.width - 3, self.y + self.height - 1)
