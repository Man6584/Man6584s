...
SINGLE_PYRAMID = 2
MULTI_PYRAMID = 3
LOCK_PROB = 5 -- Assignment: Chances of the locked bricks
...
function LevelMaker.createMap(level)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            --Assignment
            --Implementing chances for bricks to be locked
            local islocked = math.random(0, 100) < LOCK_PROB and true or false
            ...
            b = Brick(
                ...
                * 32                    -- multiply by 32, the brick width
                ...
                islocked                --Adding the locked boolean value
            )
